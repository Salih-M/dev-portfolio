<template>
  ...
  >
  <p class="text-black text-4xl font-semibold text-center my-8 text-lime-700">Blogs</p>
    <div class="grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
      <div v-for="blog in blogsData" :key="blog.id" class="flex">
        ...
        <div>
          ...
          <div class="flex items-center">
            <router-link v-if="blog.content" :to="{ name: 'blog-details', params: { id: blog.id } }" aria-label="Author" title="Author" class="mr-3">
              <img
